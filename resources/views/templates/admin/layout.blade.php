                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a hef="#"><i class="fa fa-home"></i> Inicio </a></li>
                                <li><a><i class="fa fa-edit"></i> Productos <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('marcas.index')}}">Marcas</a></li>
                                        <li><a href="{{route('producto-categorias.index')}}">Categorias</a></li>
                                        <li><a href="{{route('productos.index')}}">Productos</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{route('clientes.index')}}"><i class="fa fa-user"></i> Clientes </a></li>
                                <li><a href="{{route('pedidos.index')}}"><i class="fa fa-shopping-cart"></i> Pedidos </a></li>
